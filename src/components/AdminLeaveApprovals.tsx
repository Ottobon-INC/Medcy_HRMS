         ...
         <div className="space-y-4 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
           <div>
            ...
            <p className="font-bold text-slate-700 mt-1 flex items-center gap-1.5">
             ...
             <span className="px-2 py-0.5 bg-[#f3edfb] text-[#7e3acb] text-[10px] font-black rounded-full">
           ...
           <div>
            ...
            <p className="font-bold text-[#7e3acb] mt-1 uppercase">
             {req.type} LEAVE
            </p>
           </div>
          </div>
          ...
          <div className="space-y-1">
           ...
           <input
            ...
            className="w-full px-4 py-2 bg-white border border-slate-200 rounded-xl text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700"
           />
          </div>
         </div>
       ...
       <tbody className="divide-y divide-slate-100">
        {processedRequests.map(({ emp, req }) => (
         <tr key={req.id} className="hover:bg-slate-50/50">
          ...
          <td className="p-4 text-xs font-semibold uppercase text-[#7e3acb]">{req.type}</td>
