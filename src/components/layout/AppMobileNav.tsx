   ...
   {isAdmin ? (
    ...
    <>
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'adminDashboard' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'adminTasks' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'directory' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'attendanceOverview' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'leaveApprovals' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'officeLocations' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'messages' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'fieldOps' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <MapPin className="w-5 h-5"/>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'adminSettings' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
    ...
    <>
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'dashboard' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <Home className="w-5 h-5"/>
      <span className="text-[8px] font-bold uppercase mt-1 leading-none">Home</span>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'tasks' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <CheckSquare className="w-5 h-5"/>
      <span className="text-[8px] font-bold uppercase mt-1 leading-none">Work</span>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'fieldDuty' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <MapPin className="w-5 h-5"/>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'attendance' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <Calendar className="w-5 h-5"/>
      <span className="text-[8px] font-bold uppercase mt-1 leading-none">Attend</span>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'leave' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
      <Moon className="w-5 h-5"/>
     ...
     <button
      ...
      className={`shrink-0 flex flex-col items-center justify-center min-w-[3.5rem] h-12 rounded-xl transition-all cursor-pointer ${
       activeTab === 'employeeMissedPunches' ? 'text-[#8a42db] scale-105' : 'text-slate-400 hover:text-slate-600'
      }`}
     >
