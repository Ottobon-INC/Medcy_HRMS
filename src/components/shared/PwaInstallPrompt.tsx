  ...
  <>
   ...
   {showPrompt && deferredPrompt && (
    <div className="fixed bottom-20 md:bottom-6 left-4 right-4 md:left-auto md:right-6 md:max-w-md z-50 animate-in fade-in slide-in-from-bottom-4 duration-300">
     <div className="bg-slate-900/95 border border-[#8a42db]/40 rounded-2xl p-4 shadow-md shadow-teal-950/50 flex items-center justify-between gap-4 text-white">
      ...
      <div className="flex items-center gap-2 shrink-0">
       <button
        ...
        className="bg-[#f3edfb]0 hover:bg-teal-400 text-slate-950 font-semibold text-xs px-3.5 py-2 rounded-xl flex items-center gap-1.5 transition-all shadow-md active:scale-95"
       >
