     ...
     <div className="relative z-10 p-6 sm:p-8 pt-10">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6 bg-slate-50/70 p-4 rounded-2xl border border-slate-100">
       ...
       <div>
        ...
        <span className="text-xs font-bold text-[#7e3acb] uppercase tracking-wider">{currentUser.role}</span>
       </div>
       <div>
      ...
      <div className="bg-slate-50/80 rounded-2xl p-5 border border-slate-100 shadow-sm">
       <div className="flex items-center justify-between gap-2 mb-4">
        <div className="flex items-center gap-2">
         <div className="w-8 h-8 rounded-lg bg-[#f3edfb] flex items-center justify-center text-[#8a42db]">
        ...
        <span className="text-[10px] font-bold uppercase tracking-wider bg-purple-100/60 text-[#7e3acb] px-2 py-0.5 rounded-full">
         Security
        </span>
       </div>
        ...
        <div className="space-y-1.5">
         ...
         <div className="relative">
          ...
          <input
           ...
           className="w-full pl-9 pr-10 py-2 bg-white border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#8a42db]/20 focus:border-[#8a42db] text-slate-800 font-mono placeholder:font-sans transition-all"
          />
          <button
           type="button"
