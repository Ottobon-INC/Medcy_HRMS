  ...
  <div className="space-y-6 animate-fadeIn">
   ...
   <div className="bg-white rounded-[32px] p-6 border border-slate-100 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
    <div>
     <h2 className="text-xl font-bold font-display text-slate-800 flex items-center gap-2">
      <MapPin className="w-5 h-5 text-[#8a42db]"/>
      {title}
     </h2>
    ...
    <button
     ...
     className="px-5 py-2.5 bg-[#8a42db] hover:bg-[#7e3acb] text-white rounded-xl text-xs font-bold uppercase tracking-wider flex items-center gap-2 transition-all"
    >
     ...
     <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
      ...
      <div className="pt-4 border-t border-slate-50">
       <button
        ...
        className="px-6 py-3 bg-[#8a42db] hover:bg-[#7e3acb] disabled:opacity-50 text-white rounded-xl text-xs font-bold uppercase tracking-wider flex items-center gap-2 transition-all"
       >
   ...
   <div className="bg-white rounded-[32px] p-8 border border-slate-100 shadow-sm">
    {isLoading ? (
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {locations.map(loc => (
       <div key={loc.id} className={`p-5 rounded-2xl border transition-all ${loc.is_active ? 'border-teal-100 bg-[#f3edfb]/10' : 'border-slate-200 bg-slate-50/50 grayscale'}`}>
