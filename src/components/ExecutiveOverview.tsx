  ...
  <div className="space-y-6 animate-fadeIn pb-12">
   ...
   <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
    ...
    <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm space-y-2">
     ...
     <button 
      onClick={() => setActiveTab('leaveApprovals')}
      className="text-[11px] font-bold text-[#8a42db] hover:text-[#7e3acb] flex items-center gap-1 cursor-pointer"
     >
   ...
   <div className="space-y-3">
    <div className="flex items-center justify-between">
     <div className="flex items-center gap-2">
      <Building2 className="w-4 h-4 text-[#8a42db]"/>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
     ...
     <div className="bg-white rounded-2xl p-6 border-2 border-[#8a42db]/20 shadow-sm space-y-4 relative overflow-hidden">
      <div className="flex items-start justify-between">
       <div>
        <span className="bg-[#f3edfb] text-[#7e3acb] border border-purple-200 text-[10px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-md">
         Main Center
        </span>
       ...
       <div className="w-10 h-10 rounded-xl bg-[#f3edfb] flex items-center justify-center text-[#7e3acb] font-black">
        VZ
       </div>
      </div>
      ...
      <div className="flex items-center justify-between text-xs pt-1">
       ...
       <button
        ...
        className="text-[#8a42db] hover:text-[#7e3acb] font-bold text-xs flex items-center gap-1 cursor-pointer"
       >
   ...
   <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div className="lg:col-span-2 bg-white rounded-2xl p-6 border border-slate-100 shadow-sm space-y-4">
     <div className="flex items-center justify-between">
      <div className="flex items-center gap-2">
       <TrendingUp className="w-4 h-4 text-[#8a42db]"/>
      ...
      <button
       ...
       className="text-xs font-bold text-[#8a42db] hover:text-[#7e3acb] cursor-pointer"
      >
       Full Log →
      </button>
     </div>
         ...
         <div className="flex items-center gap-3 text-right">
          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider ${
           branch === 'visakhapatnam' 
            ? 'bg-[#f3edfb] text-[#7e3acb] border border-purple-200' 
