    ...
    <form onSubmit={handleSubmit} className="p-6 space-y-4">
     ...
     <div>
      ...
      <input 
       required
       type="text"
       className="w-full px-4 py-3 bg-slate-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-[#8a42db]"
     ...
     <div className="pt-4 flex gap-3">
      ...
      <button
       type="submit"
       disabled={loading}
       className="flex-1 py-3 bg-[#8a42db] hover:bg-[#7e3acb] disabled:opacity-50 text-white rounded-xl text-sm font-bold transition-colors"
      >
