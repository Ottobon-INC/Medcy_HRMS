   ...
   <div className="bg-white rounded-2xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-md">
    <div className="flex items-center justify-between p-6 border-b border-slate-100">
     <div>
      <h3 className="text-xl font-black text-slate-800 flex items-center gap-2">
       <FileSpreadsheet className="w-6 h-6 text-[#8a42db]"/>
    ...
    <div className="p-6 overflow-y-auto flex-1">
     <div className="flex flex-col sm:flex-row gap-6 mb-6">
      <div className="flex-1">
       <label className="border-2 border-dashed border-purple-200 bg-[#f3edfb]/50 rounded-2xl p-8 flex flex-col items-center justify-center text-center cursor-pointer hover:bg-[#f3edfb] transition-colors">
        <Upload className="w-10 h-10 text-[#8a42db] mb-3"/>
        <span className="text-sm font-bold text-[#6a2baf]">
         {file ? file.name : 'Click to Upload Excel (.xlsx)'}
        </span>
        <span className="text-xs text-[#8a42db]/70 mt-1 font-medium">
    ...
    <div className="p-6 border-t border-slate-100 bg-slate-50 rounded-b-3xl flex justify-end gap-3">
     ...
     <button
      ...
      className="px-6 py-2.5 text-sm font-bold text-white bg-[#8a42db] hover:bg-[#7e3acb] disabled:opacity-50 rounded-xl shadow-sm shadow-teal-600/20 transition-all flex items-center gap-2"
     >
      {isUploading ? (
       <>
