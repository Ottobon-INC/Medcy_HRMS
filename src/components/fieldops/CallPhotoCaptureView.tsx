   ...
   <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
    <div>
     <div className="flex items-center gap-2.5">
      <div className="w-10 h-10 rounded-2xl bg-[#8a42db] text-white flex items-center justify-center shadow-md shadow-teal-600/20">
    ...
    <div className="flex items-center justify-between pb-3 border-b border-slate-100">
     <div>
      <h3 className="text-base font-black text-slate-800 flex items-center gap-2">
       <Phone className="w-4 h-4 text-[#8a42db]"/>
       ...
       return (
        <div
         ...
         className={`p-5 rounded-2xl border transition-all space-y-3.5 ${
          isOngoing
           ? 'border-[#8a42db] bg-[#f3edfb]/40 shadow-sm'
           : isCompleted
        ...
        >
         <div className="flex justify-between items-start gap-3">
          <div className="flex-1 min-w-0">
           <span className="text-[10px] font-black uppercase text-[#7e3acb] tracking-wider">
