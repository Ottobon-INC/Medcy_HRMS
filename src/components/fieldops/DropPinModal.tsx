    ...
    <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-5 flex-1">
     ...
     <div className="pt-2 flex gap-3">
      ...
      <button
       type="submit"
       disabled={saving}
       className="flex-1 py-3 px-4 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-bold transition-all shadow-sm shadow-purple-600/25 flex items-center justify-center gap-2 text-sm disabled:opacity-50 cursor-pointer"
      >
       {saving ? (
        'Saving Pin...'
       ) : (
