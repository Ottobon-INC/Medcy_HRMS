   ...
   <div id="directory-inspect-view"className="space-y-6 animate-fadeIn">
    ...
    <div className="bg-white rounded-[32px] p-6 border border-slate-100 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
     <div className="flex items-center gap-4">
      ...
      <div>
       <p className="text-[10px] text-[#8a42db] font-bold uppercase tracking-widest">{dirText.inspecting}</p>
      ...
      <div className="p-4 sm:p-6 flex flex-col items-center">
       <div className="w-full flex justify-end mb-6">
        <button
         ...
         className="flex items-center gap-2 bg-[#8a42db] hover:bg-[#7e3acb] text-white px-4 py-2 rounded-xl text-xs font-bold shadow-md shadow-teal-600/15 transition-all"
        >
              ...
              <div className="flex items-start gap-2">
               {todayLog.photoUrl && (
                <img 
                 ...
                 className="w-8 h-8 object-cover rounded border border-slate-200 cursor-pointer hover:ring-2 hover:ring-[#8a42db] transition-all shrink-0 mt-0.5"
                />
               )}
               {todayLog.checkInLocation && (
                <div className="text-[10px] text-slate-600 font-medium leading-tight flex items-start gap-1">
                 <span className="text-[#8a42db] shrink-0 mt-0.5">📍</span>
         ...
         <td className="p-5 text-right"onClick={(e) => e.stopPropagation()}>
          <div className="flex items-center justify-end gap-2">
           <button
            ...
            className="p-2 text-slate-400 hover:text-[#8a42db] hover:bg-[#f3edfb] rounded-lg transition-colors cursor-pointer"
     ...
     <div className="bg-white rounded-[28px] sm:rounded-[32px] w-full max-w-lg shadow-md animate-scaleUp flex flex-col max-h-[90vh] my-auto overflow-hidden border border-slate-100">
      ...
      <form onSubmit={handleAddSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-4 flex-1">
       <div className="space-y-1">
        ...
        <div className="relative">
         ...
         <input
          ...
          className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700"
         />
        </div>
       </div>
        ...
        <div className="space-y-1">
         ...
         <div className="relative">
          <input
           ...
           className="w-full px-4 pr-10 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700"
          />
          <button
           type="button"
        ...
        <div className="space-y-1">
         ...
         <div className="relative">
          ...
          <input
           ...
           className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700 font-mono"
          />
         </div>
        </div>
       </div>
       ...
       <div className="pt-2 pb-2 mt-4 border-t border-slate-100">
        ...
        <div className="grid grid-cols-2 gap-4 mb-2">
         <div className="space-y-1">
          ...
          <input type="text"value={formBankName} onChange={e => setFormBankName(e.target.value)} className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700"/>
         </div>
         <div className="space-y-1">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">{t.bankAccountNo || 'Account No'}</label>
          <input type="text"value={formBankAccountNo} onChange={e => setFormBankAccountNo(e.target.value)} className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700 font-mono"/>
         </div>
         <div className="space-y-1">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">{t.bankIfsc || 'IFSC Code'}</label>
          <input type="text"value={formBankIfsc} onChange={e => setFormBankIfsc(e.target.value)} className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700 font-mono"/>
         </div>
         <div className="space-y-1">
          <label className="text-[10px] font-bold text-slate-400 uppercase tracking-wider block">{t.bankAccountType || 'Account Type'}</label>
          <select value={formBankAccountType} onChange={e => setFormBankAccountType(e.target.value as 'savings'|'current')} className="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/10 text-slate-700">
       ...
       <div className="flex justify-end gap-3 pt-4 border-t border-slate-100">
        ...
        <button
         type="submit"
         className="px-5 py-2.5 bg-[#8a42db] hover:bg-[#7e3acb] text-white rounded-xl text-xs font-bold uppercase transition-colors cursor-pointer shadow-md shadow-teal-600/20"
        >
         {dirText.btnSave}
        </button>
       </div>
