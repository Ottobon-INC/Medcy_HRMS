   ...
   <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
    ...
    <div>
     {!session ? (
      ...
      <div className="bg-[#f3edfb] text-[#8a42db] px-6 py-3 rounded-xl font-bold flex items-center gap-2">
      ...
      <div className="grid gap-4">
       {visits.map(visit => {
        ...
        return (
         <div
          key={visit.id}
          className="bg-white border border-slate-200 rounded-2xl p-4 hover:border-[#8a42db] hover:shadow-md transition-all space-y-3"
         >
