...
export default function AdminTaskManager({
 ...
 const getPriorityBadge = (priority: TaskPriority) => {
  switch (priority) {
   ...
   case 'medium':
    return (
     <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-[#f3edfb] text-[#7e3acb] border border-purple-200">
   ...
   <div className="bg-white rounded-[32px] p-6 sm:p-8 border border-slate-100 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
    <div>
     <div className="flex items-center gap-2.5">
      <div className="w-10 h-10 rounded-2xl bg-[#f3edfb] text-[#8a42db] flex items-center justify-center">
    ...
    <div className="flex flex-wrap items-center gap-3">
     ...
     <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200/50">
      <button
       ...
       className={`p-1.5 rounded-lg transition-all cursor-pointer ${
        viewMode === 'table' ? 'bg-white text-[#7e3acb] shadow-sm' : 'text-slate-400 hover:text-slate-600'
       }`}
       title="Table View"
      >
      ...
      <button
       ...
       className={`p-1.5 rounded-lg transition-all cursor-pointer ${
        viewMode === 'kanban' ? 'bg-white text-[#7e3acb] shadow-sm' : 'text-slate-400 hover:text-slate-600'
       }`}
       title="Kanban View"
      >
     ...
     <div className="flex items-center gap-2">
      ...
      className="px-4 py-2.5 bg-[#8a42db] hover:bg-[#7e3acb] active:scale-95 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all flex items-center gap-1.5 shadow-sm shadow-teal-600/10 cursor-pointer"
     >
   ...
   <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm flex flex-col md:flex-row items-center gap-3">
    <div className="relative flex-1 w-full">
     ...
     <input
      ...
      className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/20 text-slate-700"
     />
    </div>
         ...
         return (
          <tr key={task.id} className="hover:bg-slate-50/60 transition-colors group">
           ...
           <td className="py-4 px-4">
            {assignedEmp ? (
             <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-full bg-[#f3edfb] text-[#7e3acb] flex items-center justify-center font-bold text-[10px]">
           ...
           <td className="py-4 px-4 font-mono text-[11px] text-slate-600">
            {taskDate === todayStr ? (
             <span className="font-bold text-[#7e3acb] bg-[#f3edfb] px-2 py-0.5 rounded-full">
            ...
            <div className="flex items-center justify-end gap-1.5">
             ...
             {task.status !== 'completed' && task.assignedTo && (
              <button
               ...
               className="p-2 text-slate-400 hover:text-[#8a42db] hover:bg-[#f3edfb] rounded-xl transition-all cursor-pointer"
      ...
      <form onSubmit={handleSaveForm} className="p-6 space-y-4 text-xs">
       ...
       <div className="space-y-1.5">
        ...
        <textarea
         ...
         className="w-full p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/20 text-slate-700"
        />
       </div>
       ...
       <div className="pt-4 flex items-center justify-end gap-3 border-t border-slate-100">
        ...
        <button
         ...
         className="px-6 py-2.5 bg-[#8a42db] hover:bg-[#7e3acb] disabled:opacity-50 text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all shadow-sm shadow-teal-600/10 cursor-pointer"
        >
