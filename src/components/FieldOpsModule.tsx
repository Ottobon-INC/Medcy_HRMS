   ...
   <div className="bg-white rounded-[24px] p-6 shadow-sm border border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-4">
    ...
    <div className="flex flex-col sm:flex-row items-center gap-3">
     ...
     <button
      ...
      className="bg-[#8a42db] hover:bg-[#7e3acb] text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-colors shadow-sm shadow-teal-600/20 cursor-pointer"
     >
    ...
    <div className="bg-white rounded-[24px] p-6 sm:p-8 shadow-sm border border-slate-100 space-y-6">
     ...
     <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
      ...
      <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
       ...
       <div className="flex bg-slate-100 p-1 rounded-xl text-xs font-bold gap-1">
        ...
        >
         <Users className="w-3.5 h-3.5 text-[#8a42db]"/>
     ...
     {loading ? (
      <div className="py-12 flex flex-col items-center justify-center space-y-3">
       <div className="w-8 h-8 border-3 border-[#7e3acb] border-t-transparent rounded-full animate-spin"></div>
          ...
          <div key={emp.id} className="bg-white rounded-2xl border border-slate-200/80 shadow-sm hover:shadow-md transition-all hover:border-teal-400 overflow-hidden">
           ...
           >
            ...
            <div className="flex gap-3 flex-1 min-w-0">
             <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-teal-50 to-teal-100/60 text-[#7e3acb] flex items-center justify-center text-sm font-black border border-purple-200/60 shadow-xs shrink-0">
             ...
             <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-1.5 shrink-0">
               <button
                ...
                className="flex items-center gap-1 px-2.5 py-1 text-[10px] font-bold text-[#6a2baf] bg-[#f3edfb] hover:bg-purple-100 border border-purple-200/80 rounded-xl transition-all shadow-2xs cursor-pointer group"
                title="Click to view employee location on map"
               >
                <MapPin className="w-3 h-3 text-[#8a42db] group-hover:scale-125 transition-transform shrink-0"/>
           ...
           <div className="flex items-center gap-4 text-xs shrink-0 min-w-0 overflow-x-auto pb-2 xl:pb-0">
            <div className="flex flex-col items-start text-slate-500 border-r border-slate-200 pr-4">
             <span className="flex items-center gap-1.5 font-medium mb-1">
              <Clock className="w-3.5 h-3.5 text-[#8a42db]"/> Duration
             </span>
             <span className="font-bold text-slate-800 bg-[#f3edfb] px-2.5 py-1 rounded-md border border-teal-100/50">
              {formattedDuration}
             </span>
            </div>
            ...
            <div className="flex items-center gap-3 shrink-0">
             ...
             <div
              ...
              className="p-2 rounded-xl bg-slate-50 hover:bg-[#f3edfb]/60 border border-slate-200/80 hover:border-purple-300 transition-all cursor-pointer group flex items-center gap-2"
             ...
             >
              <div className="relative w-10 h-10 rounded-lg overflow-hidden shrink-0 bg-slate-200 border border-slate-200 shadow-2xs">
               {startPhoto ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-purple-100/50 text-[#7e3acb]">
              ...
              <div className="min-w-0">
               <span className="text-[10px] font-black uppercase text-[#7e3acb] tracking-wider block">Start Photo</span>
               <span className="text-[11px] font-black text-slate-800 font-mono block truncate">{startTime}</span>
               {startPhoto ? (
                <span className="text-[9px] text-[#8a42db] font-bold group-hover:underline flex items-center gap-0.5 mt-0.5">
         ...
         return (
          ...
          >
           ...
           {visit.completionNotes && (
            <div className="bg-[#f3edfb]/70 border border-teal-100 rounded-xl p-2.5 space-y-1">
             <div className="flex items-center gap-1 text-[10px] font-black text-[#6a2baf] uppercase tracking-wider">
              <FileText className="w-3 h-3 text-[#8a42db]"/>
              <span>Departure Summary Notes</span>
             </div>
             <p className="text-xs text-slate-700 leading-relaxed font-medium whitespace-pre-wrap pl-4 border-l-2 border-[#8a42db]">
              {visit.completionNotes}
             </p>
            </div>
           )}
