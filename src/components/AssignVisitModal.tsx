   ...
   <div className="bg-white rounded-[28px] sm:rounded-[32px] shadow-md w-full max-w-4xl max-h-[92vh] flex flex-col my-auto overflow-hidden border border-slate-100 animate-scaleUp">
      ...
      <div className="space-y-4">
       ...
       <div className="grid grid-cols-2 gap-3">
        <div>
         ...
         <select
          className="w-full px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-[#8a42db]/20 text-slate-700"
          value={visitType}
    ...
    <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/50 flex justify-end gap-3">
     ...
     <button
      ...
      className="px-6 py-2.5 bg-[#8a42db] hover:bg-[#7e3acb] disabled:opacity-50 text-white rounded-xl text-xs font-bold uppercase transition-colors shadow-md shadow-teal-600/20 flex items-center gap-2 cursor-pointer"
     >
      <Navigation2 className="w-4 h-4"/>
