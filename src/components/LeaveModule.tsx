  ...
  <div id="leave-module-root"className="space-y-6">
   ...
   <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-6 rounded-[32px] border border-slate-100 shadow-sm">
    ...
    <div className="flex items-center gap-3 bg-slate-50 px-4 py-2.5 rounded-xl border border-slate-100">
     ...
     >
      {managerMode ? (
       <ToggleRight className="w-9 h-9 text-[#8a42db]"/>
      ) : (
   ...
   <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    {showManageModal && (
     <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-[32px] w-full max-w-sm p-6 shadow-md animate-scaleUp">
       <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
        <ShieldAlert className="w-5 h-5 text-[#8a42db]"/>
        Manage Balance
       </h3>
       ...
       <form onSubmit={handleSaveManage} className="space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-4">
         ...
         <button
          type="submit"
          className="px-5 py-2 bg-[#8a42db] hover:bg-[#7e3acb] text-white rounded-xl text-xs font-bold uppercase transition-colors cursor-pointer"
         >
          Save
         </button>
        </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
       <div>
        ...
        <select
         ...
         className="w-full border border-slate-200 bg-slate-50 hover:bg-slate-100/50 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-[#7e3acb] font-medium transition-all"
        >
       ...
       <div className="grid grid-cols-2 gap-4">
        <div>
         ...
         <input
          ...
          className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-[#7e3acb] font-mono transition-all"
         />
        </div>
        <div>
         <label className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-1.5">
       ...
       <div>
        ...
        <textarea
         ...
         rows={3}
         className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-teal-600/20 focus:border-[#7e3acb] transition-all placeholder:text-slate-400"
        />
       </div>
       ...
       <button
        id="submit-leave-btn"
        type="submit"
        className="w-full bg-[#8a42db] hover:bg-[#7e3acb] text-white py-3 rounded-xl font-bold text-sm tracking-wide shadow-md shadow-teal-600/10 active:scale-95 transition-all flex items-center justify-center gap-2 cursor-pointer"
       >
